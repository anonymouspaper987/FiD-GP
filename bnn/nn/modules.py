...
class InducingLinear(InducingMixinLinear, nn.Linear): pass
class InducingConv1d(InducingMixin, nn.Conv1d): pass
class InducingConv2d(InducingMixin, nn.Conv2d): pass
class InducingConv3d(InducingMixin, nn.Conv3d): pass
